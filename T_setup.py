...
print'( \x1b[38;5;196m[\x1b[38;5;46m•\x1b[38;5;196m]\x1b[38;5;46m THIS TOOL MAKE BY VIRUS TEM-NSN')
...
def Main():
	os.system('xdg-open https://www.facebook.com/ITS.ME.DEVIL.NAJMU')
	os.system('clear')
	print(logo)
	print(60*'\033[1;32m═')
	print('\x1b[38;5;196m[\x1b[38;5;46m1\x1b[38;5;196m]\033[1;32m TERMUX SETUP  \x1b[38;5;196m[\x1b[38;5;46mFULL-SETUP\x1b[38;5;196m] ')
	print('\x1b[38;5;196m[\x1b[38;5;46m2\x1b[38;5;196m]\033[1;32m TERMUX SETUP  \x1b[38;5;196m[\x1b[38;5;46mBASIC -SETUP\x1b[38;5;196m] ')
	print('\x1b[38;5;196m[\x1b[38;5;46m3\x1b[38;5;196m]\033[1;32m Report a problem \x1b[38;5;196m[\x1b[38;5;46mADMIN\x1b[38;5;196m]')
	print('\x1b[38;5;196m[\x1b[38;5;46m0\x1b[38;5;196m]\033[1;32m Exit')
	print(60*'═')
	opt = input('\x1b[38;5;196mChoose :> \x1b[38;5;46m')
	if opt =='1':
		os.system('xdg-open https://www.facebook.com/groups/error.optin/')
		setup()
	if opt =='2':
		os.system('xdg-open https://www.facebook.com/groups/error.optin/')
		pkg()
...
def admin():
	...
	bal = input('Choose :> ')
	if bal =='1':
		os.system('xdg-open https://wa.me/+8801601770734');time.sleep(1)
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.com/DEVIL.NAJMUL');time.sleep(1)
		admin()
	if bal =='3':
		os.system('xdg-open https://www.facebook.com/groups/error.optin/');time.sleep(1)
		admin()
	if bal =='0':
		Main()
